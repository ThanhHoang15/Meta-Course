...
class RightTriangle:
    ...
    def __eq__(self, other):
        if abs(self.hypotenuse - other.hypotenuse) > 0.0001:
            return False
        return (abs(self.side1 - other.side1) <= 0.0001 and abs(self.side2 - other.side2) <= 0.0001) or (abs(self.side1 - other.side2) <= 0.0001 and abs(self.side2 - other.side1) <= 0.0001)
    def __str__(self):
